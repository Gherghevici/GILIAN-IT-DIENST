...
export default function Header(){
    ...
    return(
       <header className="flex justify-between px-5 py-2.5 md:px-10 xl:px-32 2xl:px-60 fixed w-full bg-white/70 ">
            <div className="order-2 basis-1/2 text-center md:order-1 md:text-left md:basis-1/4 ">LOGO</div>
