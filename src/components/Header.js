...
export default function Header(){
    ...
    return(
       <header className="flex justify-between z-50 px-5 md:px-10 lg:px-20 xl:px-32 2xl:px-60 py-2.5 fixed w-full bg-white/95 ">
            ...
            <div className="basis-1/4  order-1 md:order-2 md:basis-1/2 peer group">
                ...
                <div className={`group-has-[input:checked]:block hidden  md:flex md:justify-between `}>
                    <Link href={"/"}>
